...
public class DemoActivity extends Activity {
    ...
    private final BroadcastReceiver mHandleMessageReceiver =
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //if (newMessage == getString(R.string.gcm_message)) {
            	AdkConnection.sendValue('T');
            	mDisplay.append("send message to Accessory\n");
            //}
        }
    };

    private void setupUSB(){
    	mDisplay.append(getString(R.string.usb_start) + "\n");
        AdkConnection = new EasyAdkConnection(UIHandler);
    }

    private void closeUSB(){
    	mDisplay.append(getString(R.string.usb_close) + "\n");
    ...
    public class EasyAdkConnection extends EasyADK{
        ...
        public void onReceive(byte[] msg) {
                ...
                switch (msg[0]) {
                case MESSAGE:
                        mDisplay.append(Byte.toString(msg[1]) + "\n");
                        break;
                }       
        }
